          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link href="/study-buddy-demo" className="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  Study Buddy
                </Link>
      ...
      <div className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="bg-white p-8 rounded-xl shadow-2xl">
            <h1 className="text-2xl font-semibold mb-4">Study Buddy Demo</h1>
            <p className="mt-2 text-gray-600">This is a demonstration of what you can build with the Study Buddy API endpoint.</p>
            <div className="mt-6">
              <h2 className="text-lg font-medium">Features you could implement:</h2>
            ...
            <div className="mt-8">
              <p className="font-bold">Ready to add study buddy features to your app?</p>
              <a href="/api-docs" className="text-indigo-600 hover:text-indigo-700 mt-1 inline-block">
                Explore our API documentation &rarr;
              </a>
            </div>
          </div>
        </div>
